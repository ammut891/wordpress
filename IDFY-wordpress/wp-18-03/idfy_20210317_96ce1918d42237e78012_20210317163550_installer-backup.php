...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'idfy_20210317_96ce1918d42237e78012_20210317163550_archive.zip';
	const ARCHIVE_SIZE		 = '102504495';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '96ce191-17163550';
    const SECONDARY_PACKAGE_HASH = '405c200-17163550';
	const VERSION			 = '1.4.0';
