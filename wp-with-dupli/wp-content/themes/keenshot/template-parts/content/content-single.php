...
?>
	...
	<div class="col-md-8 col-sm-12 col-xs-12 blog-space <?php echo isset($keenshot_left_sidebar) && $keenshot_left_sidebar == 'right' ? 'col-md-push-4' : ''; ?>">
		...
		<?php the_post_thumbnail( 'full'); ?>
			<div class="post-info">
				<div class="post-meta"> 
					...
					<a class="like whishlist fa fa-heart" rel="<?php echo esc_attr($post->ID,'keenshot'); ?>"><?php echo esc_html(keenshot_like_count($post->ID),'keenshot'); ?></a>   
					<p>
					<?php
					 if(has_category()){
		...
		<div class="default-editor">
		  <?php echo esc_html(keenshot_related_posts_list('related')); ?>
		</div>
