                ...
                <div class="container">
                    <div class="footer-wrapper">
                            ...
                            <?php if (get_theme_mod('sample_default_footer_text_body', '')) : ?>
                                <div id="keenshot_copyright_widget-4" class="widget">
                                    <div class="copy-right">
                                        <?php
                                        if (keenshot_footer_image_option()) { ?>
                        ...
                        <div class="instagram-photos old_widget">
                            <div class="widgets">
                                <div class="widget-title">
                                    <h3><?php echo esc_html('Instagram Photos', 'keenshot'); ?></h3>
                                    <div class="stylish-border"></div>
                                </div>
...
if (!function_exists('keenshot_content_after_body_section')) :
    ...
    ?>
        <header class="header">
            <nav class="navbar">
                <div class="container">
                    <div class="navigation <?php echo esc_attr(get_theme_mod('header_layout', '')); ?>">
                        <div class="navbar-header">
                            ...
                            <div class="logo">
                                ...
                                if (!empty(has_custom_logo())) {
                                    ...
                                    echo '<h1 class="site-url"><a href="' . esc_url(home_url('/')) . '">' . esc_html(get_bloginfo('name'), 'keenshot') . '</a></h1>';
                                    echo '<h5 class="site-description"><a href="' . esc_url(home_url('/')) . '">' . esc_html(get_bloginfo('description'), 'keenshot') . '</a></h5>';
                                }
                                ?>
                            </div>
                        </div>
