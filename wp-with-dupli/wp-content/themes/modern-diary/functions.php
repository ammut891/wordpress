<?php 
	 add_action( 'wp_enqueue_scripts', 'modern_diary_enqueue_styles' );
	 function modern_diary_enqueue_styles() {
 		  wp_enqueue_style( 'parent-style', get_template_directory_uri() . '/style.css' ); 
 		  } 
 


function modern_diary_google_fonts() {

	wp_enqueue_style( 'modern-diary-google-fonts', '//fonts.googleapis.com/css?family=Roboto:400,500,700', false ); 
}

add_action( 'wp_enqueue_scripts', 'modern_diary_google_fonts' );




function modern_diary_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'navigation_text_color', array(
		'label'       => __( 'Link Color', 'modern-diary' ),
	...
	$wp_customize->add_section( 'upper_widgets', array(
		'title'      => __('Upper Widgets','modern-diary'),
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'upperwidgets_bg_color', array(
		'label'       => __( 'Background Colors', 'modern-diary' ),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'upperwidgets_title_color', array(
		'label'       => __( 'Title Colors', 'modern-diary' ),
		'section'     => 'upper_widgets',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'upperwidgets_text_color', array(
		'label'       => __( 'Text Colors', 'modern-diary' ),
		'section'     => 'upper_widgets',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'upperwidgets_link_color', array(
		'label'       => __( 'Link Colors', 'modern-diary' ),
		'section'     => 'upper_widgets',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'upperwidgets_border_color', array(
		'label'       => __( 'Border Colors', 'modern-diary' ),
		'section'     => 'upper_widgets',
		'priority'   => 1,
...
add_action( 'customize_register', 'modern_diary_customize_register', 999 );




if(! function_exists('modern_diary_customizer_css_final_output' ) ):
	function modern_diary_customizer_css_final_output(){
		?>
		...
		<?php }
		add_action( 'wp_head', 'modern_diary_customizer_css_final_output' );
		endif;